...
const SWIPER_SPACING_MOBILE = 9;
const SWIPER_SPACING = 17;

const SWIPER_BREAKPOINTS = {
  390: {
    slidesPerView: 2,
    spaceBetween: SWIPER_SPACING_MOBILE,
    slidesPerGroup: 2,
  },
...
function initMegamenu() {
  ...
  const triggerTodasCategorias = document.getElementById(
    "trigger-todas-categorias",
  );
  const triggerPrimeiroDepto = document.getElementById(
    "trigger-primeiro-depto",
  );

  const contentTodasCategorias = document.getElementById(
    "content-todas-categorias",
  );
  const contentPrimeiroDepto = document.getElementById(
    "content-primeiro-depto",
  );

  if (
    !navMenuContainer ||
    !megamenuDropdown ||
    !triggerTodasCategorias ||
    !triggerPrimeiroDepto
  )
    return;
  ...
  function openMegamenu(view) {
    ...
    megamenuDropdown.classList.add(
      "opacity-100",
      "visible",
      "pointer-events-auto",
    );
  ...
  triggerTodasCategorias.addEventListener("mouseenter", () =>
    openMegamenu("todas"),
  );
  triggerPrimeiroDepto.addEventListener("mouseenter", () =>
    openMegamenu("depto"),
  );
